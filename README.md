...
## Descrição
Este projeto é um sistema interno em C++ desenvolvido para auxiliar motoristas e supervisores de rota de uma empresa de transporte coletivo[cite: 5]. O sistema utiliza listas encadeadas como estrutura de dados principal para gerenciar as paradas e evitar que ônibus pulem pontos ou sigam a ordem incorreta do trajeto[cite: 4, 6].

## Requisitos
- **Compilador:** GCC (g++) para compilação em C++[cite: 6].
